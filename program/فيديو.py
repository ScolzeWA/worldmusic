...
@Client.on_message(command2(["تشغيل_فيديو","شغل_فيديو","شغل_فيد","تشغيل_فيد","فيديو"]) & other_filters)
...
@Client.on_message(command2(["لايف_تشغيل","مباشر_تشغيل","بث_تشغيل","لايف","مباشر","بث"]) & other_filters)
